...
package mx.states
{
	...
	public class OverrideBase extends OnDemandEventDispatcher implements IOverride
	{
		 ...
		 */
		protected var parentContext : IEventDispatcher;
		 ...
		 *  @productversion Flex 3
		 */
		public function apply( parent : IEventDispatcher ) : void
		{
		}
		 ...
		 *  @productversion Flex 3
		 */
		public function remove( parent : IEventDispatcher ) : void
		{
		}
		 ...
		 */
		protected function getOverrideContext( target : Object, parent : IEventDispatcher ) : Object
		{
			if ( target == null )
			{
				return parent;
		 ...
		 */
		protected function enableBindings( target : Object, parent : IEventDispatcher, property : String, enable : Boolean = true ) : void
		{
			if ( isBaseValueDataBound && target && parent && property )
			{
				var document : Object = target.hasOwnProperty( "document" ) ? target.document : null;
				document = !document && Object( parent ).hasOwnProperty( "document" ) ? parent['document'] : document;
